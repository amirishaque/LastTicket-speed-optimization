    ...
    return (
        <>
            <div className="small-banner">
                ...
                <div className="top-wrapper-polit-followers mobile other-pages">
              ...
              <div className="trust-pilot">
                ...
                <div className="img-wrapper">
                  ...
                  {/* <span>Excellent</span> */}
                    ...
                    <p className="top-p">Last Chance Ticket is one of the world's leading secondary ticket marketplaces. Prices may be above or below face value.</p>
                    <h1>{bannerHeading}</h1>
                    <p>{bannerText}</p>
