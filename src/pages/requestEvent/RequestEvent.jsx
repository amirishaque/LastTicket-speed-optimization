...
import '../../styles/requestevent/style.css'
          ...
          <form className="form">
            <div className="formRow">
              <div className="formCol">
                ...
                <input type="text" placeholder="Enter Event Title Here" style={{maxWidth:'465px'}}/>
              </div>
              <div className="formCol">
                <label htmlFor="category">Event Category</label>
                <input type="text" placeholder="Event Category" style={{maxWidth:'465px'}}/>
              </div>
            </div>
            <div className="formRow">
              <div className="formCol">
                <label htmlFor="venueName">Venue Name</label>
                <input type="text" placeholder="Venue Name" style={{maxWidth:'465px'}}/>
              </div>
              <div className="formCol">
            ...
            <div className="formRow">
              <div className="formCol">
                ...
                <input type="time" style={{maxWidth:'465px'}}/>
              </div>
              <div className="formCol">
