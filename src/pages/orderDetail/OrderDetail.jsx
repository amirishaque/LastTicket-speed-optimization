...
export default function OrderDetail() {
            ...
            <section className='order-detail-wrapper-outer'>
                <div className='order-detail-wrapper'>
                    <div className='heading-detail'>
                        <h2>Your Order Details (India Vs Pakistan - T20 World Cup 2024)</h2>
                        <div>
                            <figure>
                    ...
                    <div className='order-detail-box'>
                        ...
                        <div className='right-fragment'>
                            <ul>
                                ...
                                <li>
                                    <strong>AVAILABLE NO. OF TICKETS </strong>
                                    <span>4</span>
                                </li>

                            </ul>
                        </div>
                        <h4>Per Ticket Price 500$</h4>
                        ...
                        <ul>
                            <li><strong>Ticket Type : </strong>
                                <span>
                                    ...
                                    </svg> Mobile Ticket | you will be seated togather
                                </span>
                            </li>
                            {/* <li>
	...
	s1.5,0.673,1.5,1.5V29.5z"/>
                        ...
                        <p style={{color:'#0dccd7', fontSize:'18px',marginTop:'30px'}}>Great! you are logged in successfully. Please proceed to checkout.</p>
                    </div>
